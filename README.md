...
#### _A C# MVC application to track restaurants by cuisine._, _Mar. 18, 2020_

#### By **_Benjamin Thom, Hristo Dzhambov, Jonathan Carlos_**

## Description

_A program for a user to track restaurants based on custom categories (such as Home, Work, etc)._
...
|User clicks on "See all categories" or "See all items" and is routed to the corresponding view with options to add new cuisine or item|User clicks on link and the programs displays currently added items or categories|Catagories: "Home" Items: "Walk the dog"|
|A user clicks the "add new cuisine/item" link and is routed to a new cuisine/item view where they can insert cuisine/item details. Once the user inputs the details, the user can hit submit and will be routed to the categories/items view|User clicks on selected "add new" link and inserts cuisine/items details, and hits submit|"Add a new cuisine/task", Description: "Home"/"Walk the dog", click "Add new cuisine/task" button|
